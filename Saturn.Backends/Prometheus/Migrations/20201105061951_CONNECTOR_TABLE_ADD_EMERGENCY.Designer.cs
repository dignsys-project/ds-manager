...
namespace Prometheus.Migrations
{
    ...
    [Migration("20201105061951_CONNECTOR_TABLE_ADD_EMERGENCY")]
    partial class CONNECTOR_TABLE_ADD_EMERGENCY
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Prometheus.Models.Databases.Connector", b =>
                {
                    ...
                    b.Property<long?>("EmergencySceneId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("LastUpdatedSeconds")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasDefaultValue(0L);
            ...
            modelBuilder.Entity("Prometheus.Models.Databases.DepartmentLower", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("LowerDepartmentId")
                        .HasColumnType("bigint");

                    b.HasKey("Id");

                    b.HasIndex("LowerDepartmentId");

                    b.HasIndex("DepartmentId", "LowerDepartmentId")
                        .IsUnique();

                    b.ToTable("DepartmentLowers");
                });
            ...
            modelBuilder.Entity("Prometheus.Models.Databases.DepartmentResourceFolder", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("ParentDepartmentResourceFolderId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ParentDepartmentResourceFolderId");

                    b.HasIndex("DepartmentId", "ParentDepartmentResourceFolderId", "Name")
                        .IsUnique();

                    b.ToTable("DepartmentResourceFolders");
                });

            modelBuilder.Entity("Prometheus.Models.Databases.DepartmentSceneFolder", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("ParentDepartmentSceneFolderId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ParentDepartmentSceneFolderId");

                    b.HasIndex("DepartmentId", "ParentDepartmentSceneFolderId", "Name")
                        .IsUnique();

                    b.ToTable("DepartmentSceneFolders");
                });
            ...
            modelBuilder.Entity("Prometheus.Models.Databases.Resource", b =>
                {
                    ...
                    b.Property<long?>("DepartmentResourceFolderId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("DepartmentResourceFolderId");
            ...
            modelBuilder.Entity("Prometheus.Models.Databases.Scene", b =>
                {
                    ...
                    b.Property<long?>("DepartmentSceneFolderId")
                        .HasColumnType("bigint");

                    b.Property<long>("Height")
                        .HasColumnType("bigint");

                    b.Property<bool>("IsValified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false);
                    ...
                    b.HasIndex("DepartmentSceneFolderId");
            ...
            modelBuilder.Entity("Prometheus.Models.Databases.Connector", b =>
                {
                    ...
                    b.HasOne("Prometheus.Models.Databases.Scene", "EmergencyScene")
                        .WithMany()
                        .HasForeignKey("EmergencySceneId");
            ...
            modelBuilder.Entity("Prometheus.Models.Databases.DepartmentLower", b =>
                {
                    b.HasOne("Prometheus.Models.Databases.Department", "Departemnt")
                        .WithMany("DepartmentLowers")
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Prometheus.Models.Databases.Department", "LowerDepartemnt")
                        .WithMany()
                        .HasForeignKey("LowerDepartmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Prometheus.Models.Databases.DepartmentResourceFolder", b =>
                {
                    b.HasOne("Prometheus.Models.Databases.Department", "Department")
                        .WithMany("DepartmentResourceFolders")
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Prometheus.Models.Databases.DepartmentResourceFolder", "Parent")
                        .WithMany()
                        .HasForeignKey("ParentDepartmentResourceFolderId");
                });

            modelBuilder.Entity("Prometheus.Models.Databases.DepartmentSceneFolder", b =>
                {
                    b.HasOne("Prometheus.Models.Databases.Department", "Department")
                        .WithMany("DepartmentSceneFolders")
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Prometheus.Models.Databases.DepartmentSceneFolder", "Parent")
                        .WithMany()
                        .HasForeignKey("ParentDepartmentSceneFolderId");
                });
            ...
            modelBuilder.Entity("Prometheus.Models.Databases.Resource", b =>
                {
                    b.HasOne("Prometheus.Models.Databases.DepartmentResourceFolder", "DepartmentResourceFolder")
                        .WithMany()
                        .HasForeignKey("DepartmentResourceFolderId");
            ...
            modelBuilder.Entity("Prometheus.Models.Databases.Scene", b =>
                {
                    b.HasOne("Prometheus.Models.Databases.DepartmentSceneFolder", "DepartmentSceneFolder")
                        .WithMany()
                        .HasForeignKey("DepartmentSceneFolderId");
